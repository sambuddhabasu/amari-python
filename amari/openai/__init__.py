...
from amari.openai.api_resources import (
    Audio,
    ChatCompletion,
    Completion,
    Customer,
...
from amari.openai.error import APIError, InvalidRequestError, OpenAIError
from amari.openai.version import VERSION
...
amari_api_key = os.environ.get("AMARI_API_KEY")
...
amari_api_key_path: Optional[str] = os.environ.get("AMARI_API_KEY_PATH")

organization = os.environ.get("OPENAI_ORGANIZATION")
api_base = os.environ.get("OPENAI_API_BASE", "https://api.heyamari.com")
if os.environ.get("AMARI_TESTING_ENV"):
